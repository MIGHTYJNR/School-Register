...
namespace BasicSchoolList
{
    internal class DataCollection : IDataCollection
    {
        ...
        public static User? FindUser(string admissionNumber, string staffID)
        {
            return Users.Find(u => u.AdmissionNumber == admissionNumber || u.StaffID == staffID);
        ...
        {
            return Users.Any(u => u.Name == name || u.Name == sName);
            //Check if the user exist using student name or staff name 
        }
    }
}
